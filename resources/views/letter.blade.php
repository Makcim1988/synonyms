<x-layout>
    <x-slot name='title'>
		Синонимы на букву {{ mb_strtoupper($letter) }} — онлайн словарь русского языка
	</x-slot>

    <x-slot name="description">
        Синонимы на букву {{ mb_strtoupper($letter) }} — находите подходящие слова по смыслу в русском языке. Онлайн подбор синонимов бесплатно, быстро и без регистрации.
    </x-slot>

    <div class="header">
        <div class="breadcrumbs">
            <a href="{{ route('main') }}">Главная</a> > <span>Синонимы на букву "{{ mb_strtoupper($letter) }}"</span>
        </div>
